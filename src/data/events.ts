...
export const events: Event[] = [
  ...
  },
  {
    ...
    description: [
      "Omega Path — the Men's Health Day Initiative of the Omicron Mu Mu Chapter of Omega Psi Phi Fraternity, Inc. Empowering men through health awareness, education, and prevention. Building stronger men · healthier communities · brighter futures.",
      "Five speakers will discuss men's health challenges and preventive measures for a better quality of life and greater awareness — spanning health professionals, expert speakers, a mental health specialist, wellness resources, and preventative care. Health resources will be available on-site.",
    ],
